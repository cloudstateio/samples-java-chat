package io.cloudstate.samples.chat.presence;
...
import io.cloudstate.samples.chat.presence.PresenceProtos.*;
...
public class PresenceEntity {
     ...
     */
    private OnlineStatus statusMessage() {
        return OnlineStatus.newBuilder()
